...
@AllArgsConstructor
@Component
public class BrakeMqttPublisherBL {

    private static final Logger log = LoggerFactory.getLogger(BrakeMqttPublisherBL.class);
    ...
    public void publishMockData() {
        try {
            BrakeSensorData brakeSensorData = BrakeMock.brakeMockBL();
