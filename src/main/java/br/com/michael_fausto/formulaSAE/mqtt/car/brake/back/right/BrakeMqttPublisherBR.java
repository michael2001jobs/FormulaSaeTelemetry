...
@AllArgsConstructor
@Component
public class BrakeMqttPublisherBR {

    private static final Logger log = LoggerFactory.getLogger(BrakeMqttPublisherBR.class);
    ...
    public void publishMockData() {
        try {
            BrakeSensorData brakeSensorData = BrakeMock.brakeMockBR();
