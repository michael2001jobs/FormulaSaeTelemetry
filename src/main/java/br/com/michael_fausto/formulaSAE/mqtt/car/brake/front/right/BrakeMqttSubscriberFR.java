...
@Component
public class BrakeMqttSubscriberFR {

    private BrakeSensorData brakeSensorData;

    private static final Logger log = LoggerFactory.getLogger(BrakeMqttSubscriberFR.class);
    private static final String TOPIC_BRAKES = "telemetry/brake/front_right";

    private final MqttClient client;
    private final ObjectMapper objectMapper;

    public BrakeMqttSubscriberFR(MqttClient client, ObjectMapper objectMapper) {
        this.client = client;
