package br.com.michael_fausto.formulaSAE.mqtt.car.brake.back.right;
...
@Component
public class BrakeMqttSubscriberBR {

    private BrakeSensorData brakeSensorData;

    private static final Logger log = LoggerFactory.getLogger(BrakeMqttSubscriberBR.class);
    private static final String TOPIC_BRAKES = "telemetry/brake/back_right";

    private final MqttClient client;
    private final ObjectMapper objectMapper;

    public BrakeMqttSubscriberBR(MqttClient client, ObjectMapper objectMapper) {
        this.client = client;
